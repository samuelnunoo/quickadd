...
import {TextAreaInputPrompt} from "./gui/GenericInputPrompt/TextAreaInputPrompt";
...
export default class QuickAdd extends Plugin {
	...
	async onload() {
		...
		this.addCommand({
			...
			callback: async () => {
				const p = await TextAreaInputPrompt.Prompt(this.app, "Header", "placeholder", "valueset");
				console.log(p)
			}
		})
		/*END.DEVCMD*/
